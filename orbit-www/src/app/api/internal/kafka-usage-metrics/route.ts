...
/**
 * GET /api/internal/kafka-usage-metrics
 * Queries Kafka usage metrics with optional filters.
 * Used by Temporal workflows for archiving and cleanup operations.
 */
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('[Internal API] Kafka usage metrics query error:', error)
