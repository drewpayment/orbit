...
/**
 * GET /api/internal/kafka-lineage-edges
 * Queries Kafka lineage edges with optional filters.
 * Used by Temporal workflows for lineage processing and maintenance.
 */
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('[Internal API] Kafka lineage edges query error:', error)
