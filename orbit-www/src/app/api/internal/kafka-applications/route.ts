...
/**
 * GET /api/internal/kafka-applications
 * Queries Kafka applications with optional filters.
 * Used by Temporal workflows for querying applications.
 */
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('[Internal API] Kafka applications query error:', error)
