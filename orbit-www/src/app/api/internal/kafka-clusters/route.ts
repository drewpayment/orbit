...
/**
 * GET /api/internal/kafka-clusters
 * Queries Kafka clusters with optional filters.
 * Used by Temporal workflows for querying clusters.
 */
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('[Internal API] Kafka clusters query error:', error)
