...
import { ApplicationLineageClient } from './application-lineage-client'
...
export default async function ApplicationLineagePage({ params }: PageProps) {
