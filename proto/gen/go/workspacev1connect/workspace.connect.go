...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/drewpayment/orbit/proto/gen/go/idp/workspace/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	WorkspaceServiceName = "idp.workspace.v1.WorkspaceService"
)
...
const (
	...
	// CreateWorkspace RPC.
	WorkspaceServiceCreateWorkspaceProcedure = "/idp.workspace.v1.WorkspaceService/CreateWorkspace"
	// WorkspaceServiceGetWorkspaceProcedure is the fully-qualified name of the WorkspaceService's
	// GetWorkspace RPC.
	WorkspaceServiceGetWorkspaceProcedure = "/idp.workspace.v1.WorkspaceService/GetWorkspace"
	// WorkspaceServiceListWorkspacesProcedure is the fully-qualified name of the WorkspaceService's
	// ListWorkspaces RPC.
	WorkspaceServiceListWorkspacesProcedure = "/idp.workspace.v1.WorkspaceService/ListWorkspaces"
	// WorkspaceServiceUpdateWorkspaceProcedure is the fully-qualified name of the WorkspaceService's
	// UpdateWorkspace RPC.
	WorkspaceServiceUpdateWorkspaceProcedure = "/idp.workspace.v1.WorkspaceService/UpdateWorkspace"
	// WorkspaceServiceDeleteWorkspaceProcedure is the fully-qualified name of the WorkspaceService's
	// DeleteWorkspace RPC.
	WorkspaceServiceDeleteWorkspaceProcedure = "/idp.workspace.v1.WorkspaceService/DeleteWorkspace"
	// WorkspaceServiceAddMemberProcedure is the fully-qualified name of the WorkspaceService's
	// AddMember RPC.
	WorkspaceServiceAddMemberProcedure = "/idp.workspace.v1.WorkspaceService/AddMember"
	// WorkspaceServiceUpdateMemberRoleProcedure is the fully-qualified name of the WorkspaceService's
	// UpdateMemberRole RPC.
	WorkspaceServiceUpdateMemberRoleProcedure = "/idp.workspace.v1.WorkspaceService/UpdateMemberRole"
	// WorkspaceServiceRemoveMemberProcedure is the fully-qualified name of the WorkspaceService's
	// RemoveMember RPC.
	WorkspaceServiceRemoveMemberProcedure = "/idp.workspace.v1.WorkspaceService/RemoveMember"
	// WorkspaceServiceListMembersProcedure is the fully-qualified name of the WorkspaceService's
	// ListMembers RPC.
	WorkspaceServiceListMembersProcedure = "/idp.workspace.v1.WorkspaceService/ListMembers"
	// WorkspaceServiceUpdateSettingsProcedure is the fully-qualified name of the WorkspaceService's
	// UpdateSettings RPC.
	WorkspaceServiceUpdateSettingsProcedure = "/idp.workspace.v1.WorkspaceService/UpdateSettings"
	// WorkspaceServiceGetSettingsProcedure is the fully-qualified name of the WorkspaceService's
	// GetSettings RPC.
	WorkspaceServiceGetSettingsProcedure = "/idp.workspace.v1.WorkspaceService/GetSettings"
)

// WorkspaceServiceClient is a client for the idp.workspace.v1.WorkspaceService service.
...
// NewWorkspaceServiceClient constructs a client for the idp.workspace.v1.WorkspaceService service.
...
func NewWorkspaceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorkspaceServiceClient {
	...
	workspaceServiceMethods := v1.File_workspace_proto.Services().ByName("WorkspaceService").Methods()
...
// CreateWorkspace calls idp.workspace.v1.WorkspaceService.CreateWorkspace.
...
// GetWorkspace calls idp.workspace.v1.WorkspaceService.GetWorkspace.
...
// ListWorkspaces calls idp.workspace.v1.WorkspaceService.ListWorkspaces.
...
// UpdateWorkspace calls idp.workspace.v1.WorkspaceService.UpdateWorkspace.
...
// DeleteWorkspace calls idp.workspace.v1.WorkspaceService.DeleteWorkspace.
...
// AddMember calls idp.workspace.v1.WorkspaceService.AddMember.
...
// UpdateMemberRole calls idp.workspace.v1.WorkspaceService.UpdateMemberRole.
...
// RemoveMember calls idp.workspace.v1.WorkspaceService.RemoveMember.
...
// ListMembers calls idp.workspace.v1.WorkspaceService.ListMembers.
...
// UpdateSettings calls idp.workspace.v1.WorkspaceService.UpdateSettings.
...
// GetSettings calls idp.workspace.v1.WorkspaceService.GetSettings.
...
// WorkspaceServiceHandler is an implementation of the idp.workspace.v1.WorkspaceService service.
...
func NewWorkspaceServiceHandler(svc WorkspaceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/idp.workspace.v1.WorkspaceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWorkspaceServiceHandler) CreateWorkspace(context.Context, *connect.Request[v1.CreateWorkspaceRequest]) (*connect.Response[v1.CreateWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.CreateWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) GetWorkspace(context.Context, *connect.Request[v1.GetWorkspaceRequest]) (*connect.Response[v1.GetWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.GetWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) ListWorkspaces(context.Context, *connect.Request[v1.ListWorkspacesRequest]) (*connect.Response[v1.ListWorkspacesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.ListWorkspaces is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) UpdateWorkspace(context.Context, *connect.Request[v1.UpdateWorkspaceRequest]) (*connect.Response[v1.UpdateWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.UpdateWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) DeleteWorkspace(context.Context, *connect.Request[v1.DeleteWorkspaceRequest]) (*connect.Response[v1.DeleteWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.DeleteWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) AddMember(context.Context, *connect.Request[v1.AddMemberRequest]) (*connect.Response[v1.AddMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.AddMember is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) UpdateMemberRole(context.Context, *connect.Request[v1.UpdateMemberRoleRequest]) (*connect.Response[v1.UpdateMemberRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.UpdateMemberRole is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) RemoveMember(context.Context, *connect.Request[v1.RemoveMemberRequest]) (*connect.Response[v1.RemoveMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.RemoveMember is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) ListMembers(context.Context, *connect.Request[v1.ListMembersRequest]) (*connect.Response[v1.ListMembersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.ListMembers is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) UpdateSettings(context.Context, *connect.Request[v1.UpdateSettingsRequest]) (*connect.Response[v1.UpdateSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.UpdateSettings is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) GetSettings(context.Context, *connect.Request[v1.GetSettingsRequest]) (*connect.Response[v1.GetSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("idp.workspace.v1.WorkspaceService.GetSettings is not implemented"))
}
