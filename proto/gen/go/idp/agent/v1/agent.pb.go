...
type ApproveActionRequest struct {
	...
	Edits         *ApprovalEdits `protobuf:"bytes,5,opt,name=edits,proto3,oneof" json:"edits,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ApproveActionRequest) GetEdits() *ApprovalEdits {
	if x != nil {
		return x.Edits
	}
	return nil
...
func (x *ApprovalEdits) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ApprovalEdits) GetDescription() string {
	if x != nil {
...
func (x *ApprovalEdits) GetTemplateKind() string {
	if x != nil {
...
func (x *ApprovalEdits) GetTemplateJson() string {
	if x != nil {
