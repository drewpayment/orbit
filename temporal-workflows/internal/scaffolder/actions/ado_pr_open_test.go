...
func TestADOPROpen_Execute(t *testing.T) {
	...
	raw, err := a.Execute(context.Background(), runCtx(), json.RawMessage(`{"connection":"c","project":"proj","repoId":"repo-1","sourceBranch":"feature/x","targetBranch":"main","title":"Add x","description":"d"}`))
